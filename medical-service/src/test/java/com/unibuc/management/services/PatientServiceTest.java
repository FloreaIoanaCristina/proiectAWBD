...
class PatientServiceTest {
    ...
    void getPatientByUsername_shouldReturnPatient() {
        when(patientRepository.findByUsername("user")).thenReturn(Optional.of(patient));
    ...
    void createPatient_shouldCreateSuccessfully() {
        ...
        when(insuranceProviderRepository.findById(1)).thenReturn(Optional.of(provider));
    ...
    void createPatient_shouldThrow_whenInsuranceNotFound() {
        dto.setInsuranceProviderId(1);
        when(insuranceProviderRepository.findById(1)).thenReturn(Optional.empty());
