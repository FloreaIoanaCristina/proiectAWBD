...
class DoctorServiceTest {
    ...
    void createDoctor_shouldCreateSuccessfully() {
        ...
        when(medicalServiceRepository.findById(100)).thenReturn(Optional.of(medicalService));
    ...
    void createDoctor_shouldThrow_whenMedicalServiceNotFound() {
        when(medicalServiceRepository.findById(100)).thenReturn(Optional.empty());
    ...
    void getDoctorByUsername_shouldReturnDoctor() {
        when(doctorRepository.findByUsername("doc")).thenReturn(Optional.of(doctor));
    ...
    void getDoctorsPaged_shouldReturnPage() {
        ...
        when(doctorRepository.findAllWithServicesPaged(any())).thenReturn(page);
