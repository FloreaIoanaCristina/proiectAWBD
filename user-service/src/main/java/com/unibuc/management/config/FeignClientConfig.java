...
/**
 * Attaches a short-lived JWT to every outgoing Feign request. When a user is
 * authenticated the token carries their username + roles; otherwise a service
 * identity token is minted (e.g. during registration).
 */
@Configuration
